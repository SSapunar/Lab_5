...
# Pets (species válidas en minúscula)
pet1 = owner1.pets.create!(name: "Firulais", species: "dog", breed: "Labrador", date_of_birth: Date.new(2020,1,1), weight: 25)
pet2 = owner1.pets.create!(name: "Michi", species: "cat", breed: "Siames", date_of_birth: Date.new(2021,1,1), weight: 5)
pet3 = owner2.pets.create!(name: "Bunny", species: "rabbit", breed: "Mini Lop", date_of_birth: Date.new(2022,1,1), weight: 2)
pet4 = owner3.pets.create!(name: "Rocky", species: "dog", breed: "Bulldog", date_of_birth: Date.new(2019,1,1), weight: 20)
pet5 = owner2.pets.create!(name: "Luna", species: "cat", breed: "Persa", date_of_birth: Date.new(2020,1,1), weight: 4)
...
# Appointments (usando enum)
appt1 = Appointment.create!(pet: pet1, vet: vet1, date: Time.now, reason: "Checkup", status: :scheduled)
appt2 = Appointment.create!(pet: pet2, vet: vet1, date: Time.now, reason: "Vaccination", status: :in_progress)
appt3 = Appointment.create!(pet: pet3, vet: vet2, date: Time.now, reason: "Injury", status: :completed)
